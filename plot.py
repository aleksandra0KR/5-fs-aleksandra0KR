...
clusters_before = kmeans_before.predict(X_test)
...
X_pca_before = pca_before.fit_transform(X_test)
...
X_tsne_before = tsne_before.fit_transform(X_test)
...
plot_data(X_pca_before, y_test, clusters_before, 'PCA Before Feature Selection')
plot_data(X_pca_after, y_test, clusters_after, 'PCA After Feature Selection')

plot_data(X_tsne_before, y_test, clusters_before, 't-SNE Before Feature Selection')
plot_data(X_tsne_after, y_test, clusters_after, 't-SNE After Feature Selection')
